...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1312706,19054825,19036892,43526424,40226579,751889,722424,713196,1309188,735843,1593457,45775146,1314273,42900584,37497593,1510913)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1312706,19054825,19036892,43526424,40226579,751889,722424,713196,1309188,735843,1593457,45775146,1314273,42900584,37497593,1510913)
  and c.invalid_reason is null
...
HAVING COUNT(DISTINCT cc.start_date) >= 3
-- End Correlated Criteria
